...
par(mfrow=c(2,1))
plot(x,weekday_average,xlab='interval',ylab='Number of steps',main='weekday',type='l',ylim=c(0,300))
plot(x,weekend_average,xlab='interval',ylab='Number of steps',main='weekend',type='l',ylim=c(0,300))
```